    ...
    <section className="support_volunteer">
      <div className="support_volunteer_banner">
        ...
        <SarmentsText format="text" className="support_volunteer_text">
          Ateliers d&apos;aide aux enfants à besoins particuliers, soutien hebdomadaire à la
          lecture, enrichissement des cours d&apos;anglais et de sport, découverte des métiers et
